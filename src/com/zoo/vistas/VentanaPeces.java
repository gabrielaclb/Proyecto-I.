...
public class VentanaPeces {
	...
	public void mostrar() {
		...
		for (int i = 0; i < listaPeces.size(); i++) {
			...
			matriz[i][3]=listaPeces.get(i).getTamaño();
			matriz[i][4]=listaPeces.get(i).getMedio();
			matriz[i][5]=listaPeces.get(i).getGenero();
			matriz[i][6]=listaPeces.get(i).getAlimentacion();
			matriz[i][7]=listaPeces.get(i).getColor();
			matriz[i][8]=Boolean.toString(listaPeces.get(i).isPelo()); //pelo
			matriz[i][9]=Integer.toString(listaPeces.get(i).getNumeroDeAletas()); 
			matriz[i][10]=Integer.toString(listaPeces.get(i).getNumeroDeBranquias()); 
			matriz[i][11]=Boolean.toString(listaPeces.get(i).isCartilaginoso()); //cartilaginoso
			matriz[i][12]=Boolean.toString(listaPeces.get(i).isOseo()); //oseo
			matriz[i][13]=Boolean.toString(listaPeces.get(i).isEscamas()); //escamas
