...
public class VentanaReptiles {
	...
	private class SwingAction extends AbstractAction {
		...
		public void mostrar() {
			String matriz [][] = new String[listaReptiles.size()][13];
			
			for (int i = 0; i < listaReptiles.size(); i++) {
				
				matriz[i][0]=listaReptiles.get(i).getNombre();
				matriz[i][1]=Integer.toString(listaReptiles.get(i).getEdad());
				matriz[i][2]=Integer.toString(listaReptiles.get(i).getPeso());
				matriz[i][3]=listaReptiles.get(i).getTamaño();
				matriz[i][4]=listaReptiles.get(i).getMedio();
				matriz[i][5]=listaReptiles.get(i).getGenero();
				matriz[i][6]=listaReptiles.get(i).getAlimentacion();
				matriz[i][7]=listaReptiles.get(i).getColor();
				matriz[i][8]=String.valueOf(listaReptiles.get(i).isPelo()); //pelo
				matriz[i][9]=String.valueOf(listaReptiles.get(i).isCaparazon());
				matriz[i][10]=String.valueOf(listaReptiles.get(i).isExtremidades());
				matriz[i][11]=String.valueOf(listaReptiles.get(i).isDientes());
				matriz[i][12]=Integer.toString(listaReptiles.get(i).getNumeroDeDientes()); 
				} 												
			table.setModel(new DefaultTableModel(
					matriz,
					new String[] {
