	...
	private class SwingAction extends AbstractAction {
		...
		public void mostrar() {
			...
			for (int i = 0; i < listaAnfibios.size(); i++) {
				...
				matriz[i][3]=listaAnfibios.get(i).getTamaño();
				matriz[i][4]=listaAnfibios.get(i).getMedio();
				matriz[i][5]=listaAnfibios.get(i).getGenero();
				matriz[i][6]=listaAnfibios.get(i).getAlimentacion();
				matriz[i][7]=listaAnfibios.get(i).getColor();
				matriz[i][8]=Boolean.toString(listaAnfibios.get(i).isPelo()); //pelo
				matriz[i][9]=Boolean.toString(listaAnfibios.get(i).isCola());
				matriz[i][10]=listaAnfibios.get(i).getTipoDeRespiracion(); 
